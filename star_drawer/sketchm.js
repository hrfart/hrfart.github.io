...
if(linkback==0){
	linkback=createA("http://harryrubinfalcone.com/interactive.html","<img src='blank.png' width='"+w*.1+"' height='"+this.h*.2+"'>");
	linkback.position(w*.88,h*.785);
...
wold=w;
hold=h;
image(imageback,w*.85,h*.75,w*.15,h*.25);
}
